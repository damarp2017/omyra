...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Halaman Tambah Penyetokan Master</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Halaman Tambah Penyetokan Master</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Form Tambah Penyetokan Master</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" enctype="multipart/form-data"
                            action="{{ route('admin.stock.master.store') }}" id="form-tambah">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="material">Material Master</label>
    ...
    $(function () {
        ...
        $('#form-tambah').validate({
            ...
            messages: {
                ...
                material: {
                    required: "Mohon pilih material master",
                },
                total: {
        ...
        $('#product').on('change', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    let html = ``;
                    html += `<option selected="selected" disabled>-- Pilih Material Master --</option>`;
